...
public class Condition
{
	...
	public Condition(YajswConfigurationImpl config, WrappedProcess wrappedProcess, Logger log)
	{
		_config = config;
		_wp = wrappedProcess;
		_log = log;
	...
	public void init()
	{
		...
		_script = ScriptFactory.createScript(fileName, "condition", _wp, argsArr, _log, 0);
